  ...
  >
    ...
    <div class="blueprint-node-body">
      ...
      <div class="blueprint-block-info">
        <div class="blueprint-block-info-line">{{ bodyMain }}</div>
        <div v-if="connectionLabel" class="blueprint-block-info-line blueprint-block-info-muted">
          {{ connectionLabel }}
        </div>
        <div v-else-if="inputsMappedCount" class="blueprint-block-info-line blueprint-block-info-muted">
          {{ inputsMappedCount }} input(s) mapped
        </div>
      </div>
    </div>
  </div>
