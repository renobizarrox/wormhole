...
const createActionBody = z.object({
  ...
  overrideBaseUrl: z.boolean().optional(),
    ...
    async (request, reply) => {
      ...
      const action = await prisma.action.create({
        data: {
          ...
          overrideBaseUrl: body.data.overrideBaseUrl ?? false,
    ...
    async (request, reply) => {
      ...
      const updated = await prisma.action.update({
        ...
        data: {
          ...
          ...(body.data.overrideBaseUrl !== undefined && { overrideBaseUrl: body.data.overrideBaseUrl }),
          ...(body.data.baseUrlOverride !== undefined && { baseUrlOverride: body.data.baseUrlOverride ?? null }),
